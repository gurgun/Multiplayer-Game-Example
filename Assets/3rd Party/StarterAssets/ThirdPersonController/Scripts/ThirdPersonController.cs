    ...
    public class ThirdPersonController : NetworkBehaviour
    {
        ...
        private void Update()
        {
            ...
            else if (IsClient && IsLocalPlayer)
            {
                ...
                Debug.Log("sent jump input to server: " + _input.jump);
        ...
        [ServerRpc]
        private void JumpServerRpc(bool inputJump)
        {
            JumpAndGravity(inputJump);
        }
        ...
        private void Move(Vector2 move)
        {
            ...
            Debug.Log("vertical velocity at move: " + _verticalVelocity);
            // update animator if using character
            if (_hasAnimator)
            {
        ...
        [ServerRpc]
        private void JumpStartServerRpc()
        {
            Debug.Log("ServerRpc jump start");
            JumpStart();
        }
        ...
        private void JumpAndGravity(bool inputJump)
        {
